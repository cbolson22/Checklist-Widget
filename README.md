...
- Color-coded history graph (muted red → warm ochre → yellow-green → medium green → dark green) based on how many tasks were completed
...
| ------------ | --------------- |
| Dark gray    | No data         |
| Muted red    | 0/5 completed   |
| Warm ochre   | 1–2/5 completed |
| Yellow-green | 3/5 completed   |
| Medium green | 4/5 completed   |
